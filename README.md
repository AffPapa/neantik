...
нотарифицированные DMG/ZIP в Releases. Локальный кандидат `0.3.20 (23)` — это
development preview и не заменяет опубликованный `0.7.3`.
...
## В локальном кандидате 0.3.20 (23)
