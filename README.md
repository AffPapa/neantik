...
Подготавливаемый Direct-кандидат имеет версию `0.3.21`, build `24`, но до
публикации этих артефактов остаётся только development preview.
...
## В кандидате 0.3.21 (24)

Следующие изменения уже находятся в исходниках кандидата, но ещё не являются
новым подписанным бинарным релизом:
...
Версия `0.3.20` опубликована для public-alpha изоляции профилей. Строгая
