...
- позволяет искать профили по имени и тегам, закреплять важные, убирать
  неактивные в архив и создавать чистую независимую копию конфигурации;
- поддерживает Direct, HTTP/HTTPS с авторизацией через нативное окно Chromium
  и SOCKS5 без логина и пароля;
- умеет локально разобрать список прокси и атомарно создать до 100 отдельных
  профилей без автоматических сетевых запросов;
