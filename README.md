...
> Возможности ниже описывают текущий исходный кандидат `0.3.17 (20)`. Они
> появятся у обычных пользователей только после публикации отдельного
> подписанного и нотарифицированного релиза. Публичная `0.3.16 (19)` пока не
> содержит все изменения этой ветки.
...
Версия `0.3.16` опубликована для public-alpha изоляции профилей. Строгая
