...
Текущий исходный кандидат для следующего public-alpha релиза:
...
- SHA-256 будут опубликованы рядом с артефактами после завершения release gates.

Публичный rollback-релиз — `0.7.4 (67)`. Кандидат `0.7.5 (68)` содержит
manager/UI и verifier-улучшения; встроенный Chromium 153 сохраняется без
пересборки. Он не становится публичным бинарным релизом до завершения
подписи, notarization, Gatekeeper и свежей проверки GitHub download.
...
## В локальном кандидате 0.7.5 (68)
