...
Новые профили по умолчанию открывают внешний инструмент
`https://aff.top/tools/fingerprint`. Страница автоматически измеряет параметры
браузера и получает сетевой адрес или адрес выбранного прокси; на ней могут
действовать собственные cookies, аналитика и срок хранения отчётов aff.top.
Стартовую страницу можно изменить до первого запуска в разделе
«Дополнительно». NeAntik не передаёт этому сайту приватный seed профиля и не
считает запросы страницы своей продуктовой телеметрией.
