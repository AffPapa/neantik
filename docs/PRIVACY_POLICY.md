...
Начиная с кандидата 0.4 новые профили открывают пустую страницу `about:blank`,
которая не обращается к внешнему сайту. Стартовую страницу можно изменить
в разделе «Дополнительно». Ранее сохранённые адреса, включая инструмент
`https://aff.top/tools/fingerprint`, автоматически не заменяются. Если профиль
открывает такой сайт, он получает сетевой адрес Mac или прокси и может
использовать свои cookies и аналитику; инструмент проверки также измеряет
параметры браузера. Это запросы выбранного сайта, не продуктовая телеметрия
NeAntik.
