...
RELEASE_SOURCE_CLOSURE: tuple[tuple[str, str], ...] = (
    ...
    ("runtime/chromium-153-build-adaptations.json", "reviewed-policy"),
    ("runtime/chromium-153-gclient-plan.json", "reviewed-policy"),
    ("runtime/chromium-153-gn-review.json", "reviewed-policy"),
    ("runtime/chromium-153-inputs/gcs-raw-output-recipe.json", "reviewed-source-inputs"),
    ("runtime/chromium-153-inputs/reviewed-cipd-payload-recipe.json", "reviewed-source-inputs"),
    ("runtime/chromium-153-inputs/reviewed-gclient-git-recipe.json", "reviewed-source-inputs"),
    ("runtime/chromium-153-inputs/reviewed-gcs-payload-recipe.json", "reviewed-source-inputs"),
    ("runtime/chromium-153-inputs/reviewed-input-bundle.json", "reviewed-source-inputs"),
    ("runtime/chromium-153-owned-port-review.json", "reviewed-policy"),
    ("runtime/chromium-153-source-contract.json", "reviewed-policy"),
    ("runtime/chromium-153-upstream-attribution.json", "reviewed-policy"),
    ("runtime/nevision-patches/patches/chromium-153-owned-port.patch", "reviewed-source-inputs"),
    ("runtime/nevision-patches/series-153.json", "reviewed-policy"),
    ("runtime/nevision-patches/series.json", "reviewed-policy"),
    ("runtime/security-baseline.json", "reviewed-policy"),
    ("runtime/security-review-153.json", "reviewed-policy"),
    ...
    ("scripts/gclient_git_recipe.py", "source-provenance"),
    ("scripts/gclient_input_bundle.py", "source-provenance"),
    ("scripts/gclient_payload_recipe.py", "source-provenance"),
    ("scripts/gclient_source_contract.py", "source-provenance"),
    ("scripts/gclient_source_evidence.py", "source-provenance"),
    ...
    ("scripts/runtime_candidate_lock.py", "source-provenance"),
    ("scripts/runtime_contract_selection.py", "source-provenance"),
    ("scripts/runtime_source_provenance.py", "source-provenance"),
