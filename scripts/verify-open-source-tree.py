...
REQUIRED_PUBLIC_PATHS = {
    ...
    "runtime/chromium-153-source-contract.json",
    "runtime/nevision-patches/patches/chromium-153-owned-port.patch",
    "runtime/nevision-patches/series-153.json",
    "runtime/chromium-153-upstream-attribution.json",
    "runtime/chromium-153-gclient-plan.json",
    "runtime/chromium-153-build-adaptations.json",
    "runtime/chromium-153-gn-review.json",
    "runtime/chromium-153-owned-port-review.json",
    "runtime/chromium-153-inputs/reviewed-input-bundle.json",
    "runtime/chromium-153-inputs/reviewed-gclient-git-recipe.json",
    "runtime/chromium-153-inputs/reviewed-cipd-payload-recipe.json",
    "runtime/chromium-153-inputs/reviewed-gcs-payload-recipe.json",
    "runtime/chromium-153-inputs/gcs-raw-output-recipe.json",
    "scripts/runtime_contract_selection.py",
    "scripts/gclient_git_recipe.py",
    "scripts/gclient_input_bundle.py",
    "scripts/gclient_payload_recipe.py",
    "scripts/gclient_source_contract.py",
    "scripts/gclient_source_evidence.py",
