## Direct 0.7.0 (63) — кандидат, не опубликован

- Собрано ядро Chromium 153.0.8010.36 для Apple Silicon с Metal; проверены происхождение исходников, подпись ядра и соответствие встроенного runtime его отчёту. GUI-приёмка и проверки распространяемых архивов ещё не завершены.
...
- Усилены проверки секретов, состава архивов и загрузки файлов. Публичный выпуск возможен только после завершения всех релизных проверок.
