...
- Встроенный движок переводится на Chromium 151.0.7922.108 — текущий
  воспроизводимый macOS security baseline из официального Stable-релиза с 41
  исправлением безопасности. Runtime будет опубликован только после свежей
  ARM64/Metal-сборки, source provenance и полного Direct release gate.
